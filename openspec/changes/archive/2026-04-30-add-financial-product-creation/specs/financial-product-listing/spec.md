...
#### Scenario: Acción principal de alta visible
- **WHEN** el usuario abra la pantalla principal del listado
- **THEN** deberá ver un botón principal `Agregar` para iniciar el registro de un producto
